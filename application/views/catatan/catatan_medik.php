    ...
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <table class="table">
            <tr>
              <td>Poli</td><td>:</td><td><input type="text" name="poli" value="<?=$pasien['poli']?>" class="form-control" readonly></td>
              <td>No CM</td><td>:</td><td><input type="text" id="noCm" name="noCm" value="<?=$pasien['noCm']?>" class="form-control" readonly></td>
              <td>Tanggal</td><td>:</td><td><input type="text" name="tanggalKunjungan" value="<?=date("d-m-Y",strtotime($pasien['tanggalKunjungan']))?>" class="form-control" readonly></td>
            </tr>
          </table>
          <table>
            <tr>
              ...
              <td>:</td>
              <td colspan="2"><textarea rows="3" class="form-control" name="anamnesa"><?=isset($cm['anamnesa'])?$cm['anamnesa']:"";?></textarea></td>
              <td></td><td></td><td></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <div class="input-group">
                  <input type="text" id="beratBadan" name="beratBadan" value="<?=isset($cm['beratBadan'])?$cm['beratBadan']:'';?>" class="form-control" onchange="IMT()">
              ...
              <td>
                <div class="input-group">
                  <input type="text" id="tinggiBadan" name="tinggiBadan" value="<?=isset($cm['tinggiBadan'])?$cm['tinggiBadan']:'';?>" class="form-control" onchange="IMT()">
                  <div class="input-group-append">
          ...
          <table>
            ...
            <tr>
              ...
              <td colspan="4">
                ...
                <div id="icdRow2" <?=isset($cm['diag2'])&&$cm['diag2']!=''?"":"style='display: none;'";?>>
                  <div class="input-group">
                    <input type="text" id="icdx2" name="diag2" value="<?=isset($cm['diag2'])?$cm['diag2']:'';?>" class="form-control" style="max-width: 16%;text-transform: uppercase;" onchange="diagnosaName(this.value,2)">
                ...
                <div id="icdRow3" <?=isset($cm['diag3'])&&$cm['diag3']!=''?"":"style='display: none;'";?>>
                  <div class="input-group">
                    <input type="text" id="icdx3" name="diag3" value="<?=isset($cm['diag3'])?$cm['diag3']:'';?>" class="form-control" style="max-width: 16%;text-transform: uppercase;"  onchange="diagnosaName(this.value,3)">
            ...
            <tr>
              ...
              <td colspan="4">
                ...
                <div id="RowTindakan1">
                  <div class="input-group">
                    <input type="text" id="kodeTindakan1" name="tindakan[]" value="" class="form-control" style="max-width: 16%">
                    ...
                    <div class="input-group-append">
                      ...
                      <button class="btn btn-outline-secondary" id="tambahTindakanId" type="button" onclick="tambahTindakan(2)">+</button>
                    </div>
                  </div>
                </div>
                </div>
                ...
                <div id="RowObat1">
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <button class="btn btn-outline-secondary" id="tambahObatId" type="button" onclick="tambahObat(2)">+</button>
                    </div>
                  </div>
                  <div class="input-group">
                    Dosis : 
